...
- **main** — основная ветка с актуальным рабочим кодом.

- **Rag_correct** — дополнительная ветка с рядом изменений:
  - исправлена загрузка файлов в базу данных (в БД остались только файлы `feat`)
  - подкорректирован код основной модели
  - проведено сравнение работы модели:
    - с RAG и без него
    - с явным указанием модели и без него

  ![Сравнение промтов](сравнение%20промтов.png)
